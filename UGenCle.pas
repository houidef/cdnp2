...
Forms, Windows,  SysUtils, Classes,dialogs;
    procedure GetCleUser_v1(a:String; b:string; c:dword;var  d:string);
    procedure GetCleUser(a:String; b:string; c:dword;var  d:string);//00497D18
...
//00497D18
procedure GetCleUser(a:String; b:string; c:dword;var  d:string);
var
  lvar_20:int64;
  ...
  //00497D18
    ...
    begin//00497D8B
	  ...
	  *)
      ...
      for I := 1 to 6 do
      begin//00497ECD
        lvar_20 := Text[I] + lvar_20;
      end;//3
      lvar_320 := IntToStr(lvar_20) + IntToStr(lvar_10);
      
      lvar_20 := 0;
      EBX := length(lvar_320);
      ESI := length(lvar_320) - 3 - EBX;//ESI - lvar_324
        for I := lvar_324 to ESI + lvar_324 - 1 do  //00497F75
        begin//4
          //00497F76
          lvar_32C := lvar_320[I];
...
begin//0
  //004981D4
    ...
    begin//0049824B
      GetCleUser(NomUser, '27572cdn2.x', c,buf);
      result := (CleUser = buf);
	  //GetCleUser_v1(NomUser, '27572cdn2.x', CleUser,buf);
    end
	else 
    result := false;
