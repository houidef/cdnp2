...
resourcestring
  ...
  SActionCategoryDesc='xxxxxxxxxxxxxxxxxxxxxx';
  SDataCategoryDesc='xxxx';
  SDatabaseCategoryDesc='xxx';
  SDragNDropCategoryDesc='xxx';
  SHelpCategoryDesc='xxx';
  SLayoutCategoryDesc='xxx';
  SLegacyCategoryDesc='xxx';
  SLinkageCategoryDesc='xxx';
  SLocaleCategoryDesc='xxx';
  SLocalizableCategoryDesc='xxx';
