...
begin//0
  //0050E744
    ...
    TabControl1.Tabs := f308.GetPeriodeNameList;
      for I := 1 to f308.NbrSerieNotes(1) do //0050E8EE
      begin//3
        //0050E8F5
...
begin//0
    ...
    SpeedButtonExecuter.Enabled := False;
      for I := 1 to f308.NbrSerieNotes(TabControl1.TabIndex + 1) do//0050EC7F
      begin//3
        //0050EC86
      ...
      //0050ED62
        ...
        begin//4
          ...
          begin//5
            ...
            lvar_C := f304.NbrSerieNotes(lvar_4);
...
begin//0
  ...
  //push ESI
    //0050F46B
    case f308.NbrSerieNotes(TabControl1.TabIndex + 1)  of
      0:
      begin//3
        //0050F4AE
    ...
    Label3.Caption  := IntToStr(f308.NbrSerieNotes(TabControl1.TabIndex + 1)) + ' séries de notes';
    //0050F504
end;//0
